...
class _HomeScreenState extends ConsumerState<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final productsAsync = ref.watch(productsProvider(const {'categoryId': 'All', 'subCategory': 'All'}));
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          ref.invalidate(productsProvider(const {'categoryId': 'All', 'subCategory': 'All'}));
        },
        child: CustomScrollView(
          ...
          slivers: [
                        ...
                        child: Column(
                          ...
                          children: [
                                        ...
                                        Expanded(
                                          child: TextField(
                                            ...
                                            decoration: const InputDecoration(
                                              hintText: "Search for 'fruits, vegetables, milk'",
                            ...
                            categoriesAsync.when(
                                ...
                                return SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      if (index == 0) {
                                        final isSelected = _activeCategory == 'All';
                                        return Padding(
                                          padding: const EdgeInsets.only(right: 8.0),
                                          child: ChoiceChip(
                                            label: const Text('All Categories', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                                            selected: isSelected,
                                      ...
                                      return Padding(
                                        padding: const EdgeInsets.only(right: 8.0),
                                        child: ChoiceChip(
                                          avatar: Icon(_getCategoryIconData(cat.icon), size: 16, color: isSelected ? Colors.white : cat.color),
                                          label: Text(cat.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Colors.white)),
                                          selected: isSelected,
                                          selectedColor: const Color(0xFF00A86B),
                                          backgroundColor: Colors.white.withOpacity(0.1),
                                          onSelected: (_) {
                              ...
                              loading: () => const SizedBox(height: 44, child: Center(child: CircularProgressIndicator(color: Colors.white))),
            ...
            bannersAsync.when(
                  ...
                  child: Container(
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final linkUrl = banner['linkUrl'] as String? ?? '/products';
              ...
              loading: () => const SliverToBoxAdapter(child: SizedBox(height: 140, child: Center(child: CircularProgressIndicator()))),
                ...
                return SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          (groups[0]['title'] as String?) ?? 'Explore Special Subcategories',
                          style: TextStyle(
                            fontSize: 15,
                          ...
                          builder: (context, constraints) {
                            ...
                            return Wrap(
                              ...
                              children: items.map((itemObj) {
                                final item = Map<String, dynamic>.from(itemObj as Map);
                                final name = item['name'] as String? ?? '';
                                final img = item['image'] as String? ?? '';
                                final link = item['link'] as String? ?? '/category/cat_veg';
                ...
                return productsAsync.when(
                  data: (allProducts) {
                    final filteredCategories = _activeCategory == 'All'
                        ? categories
                        : categories.where((c) => c.id == _activeCategory).toList();
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Icon(_getCategoryIconData(cat.icon), color: cat.color, size: 20),
                                        ),
                                        const SizedBox(width: 10),
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                    ...
                                    GestureDetector(
                                      ...
                                      child: const Row(
                                        children: [
                                          Text(
                                            'See All',
                                            style: TextStyle(color: Color(0xFF00A86B), fontWeight: FontWeight.w800, fontSize: 13),
                                          ),
                                          Icon(Icons.chevron_right_rounded, color: Color(0xFF00A86B), size: 18),
                                        ],
                                      ),
                                    ),
                                  ],
